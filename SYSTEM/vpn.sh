#!/bin/bash
# Mod By WAHID ROMDONI

# By SKT AIO
# ==================================================
# Link Hosting Kalian
SKAI0="https://raw.githubusercontent.com/Xiyunnn/wr/refs/heads/main/SYSTEM/"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/Xiyunnn/wr/refs/heads/main/SYSTEM/vpn.zip
unzip vpn.zip
rm -f vpn.zip
