#!/bin/bash
REPO="https://raw.githubusercontent.com/Xiyunnn/wr/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/Xiyunnn/v3/refs/heads/main/files/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
